    ...
    return (
        <ul className="header__navbar-list">
            <li className="header__navbar-item header__navbar-item--has-qr">
                <a href="#root" className="header__navbar-item-link">Vào cửa hàng trên ứng dụng Tickid ID</a>
                <div className="header-qrcode">
                    ...
                    <div className="qrcode-dowload">
                        <a href="#root" className="qrcode-link">
            ...
            <li className="header__navbar-item">
                Kết nối
                <a href="#root" className="header__navbar-item-link"><i className="ti-facebook"></i></a>
                <a href="#root" className="header__navbar-item-link"><i className="ti-instagram"></i></a>
            </li>
        </ul>
    )
}
